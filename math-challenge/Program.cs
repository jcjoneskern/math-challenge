...
public class NumberChecker
{
	...
	public String getNumber2(String origNum)
	{
		...
		Console.WriteLine("Enter another whole number with {0} digits:", origNum.Length);
		num = Console.ReadLine();

		while (!(Int32.TryParse(num, out int number)))
		{
			Console.WriteLine("That's not a whole number. Enter a whole number with {0} digits:", origNum.Length);
			num = Console.ReadLine();
		}
		...
		{
			Console.WriteLine("No, enter a whole number with {0} digits:", origNum.Length);
			num = Console.ReadLine();
		}
